...
export default function Home() {
  ...
  return (
    <div className="w-full lg:h-[100vh] bg-transparent flex items-center justify-center ">
      <div className="w-[80%] h-[80%] flex lg:flex-row items-center justify-between sm:flex-col md:flex-row md:w-[95%] ">
        <div className="flex flex-col items-start ">
          <div className="flex flex-col items-start gap-5">
            <h1 className="lg:text-[60px] font-Jersey font-semibold  text-white sm:text-center sm:w-full sm:text-[36px] ">Leul Mekonnen</h1>
            <h2 className="text-xl font-light  text-white">Exprienced Front-End Engineer</h2>
            <p className="text-sm font-light  text-gray-500 sm:text-center">
              I build exceptional and accessible digital experiences for the web
            </p>
          </div>
          <div className="lg:flex flex-col items-start gap-6 mt-28 sm:hidden md:flex ">
            <h1
        ...
        <div className='lg:flex  sm:hidden lg:w-1/2 '>
